    ...
    <FeaturePageShell>
      ...
      >
        <p className="max-w-2xl text-base leading-relaxed text-ink-700">
          {/* 2026-07-19 事実訂正: 「自社」は開発者が会社を所有していると読めるため、
              開発者自身の実務利用であることが分かる表現に変更。 */}
          開発者自身が実務で使ってきた中では、1件あたりの入力時間を大きく短縮できています。コピペとPDF投げ込みで下書きまで終わるので、あなたは内容の確認と手直しに集中できます。
          <span className="mt-2 block text-sm text-ink-500">
            ※「入力時間90%削減」は開発者自身の利用に基づく試算です。効果には個人差があります。
          </span>
        </p>
      </FeatureSection>
