...
export const metadata: Metadata = {
  ...
  title: {
    default: '楽マッチ AI｜不動産仲介営業専門CRM・顧客/物件管理AI（月3,000円・税込）',
    template: '%s | 楽マッチ AI',
  },
  description: '不動産仲介営業専門の顧客・物件管理AI。このお客様に何を、この物件を誰に — AIが両方から答える双方向マッチング。コピペ・PDFで物件登録（媒体連携0円）、通話録音の文字起こし・要約、お客様連動アプリ、契約・精算まで。個人でも会社でも月3,000円（税込）/人から。',
  openGraph: {
    title: '楽マッチ AI｜不動産仲介営業専門CRM・顧客/物件管理AI',
    description: 'このお客様に何を、この物件を誰に。AIが両方から答える双方向マッチング。コピペ・PDFで物件登録（媒体連携0円）、通話録音の要約、お客様連動アプリ、契約・精算まで。月3,000円（税込）/人から。',
    url: SITE_URL,
    siteName: '楽マッチ AI',
    locale: 'ja_JP',
    type: 'website',
    images: [{ url: '/ogp-new.png', width: 1200, height: 630, alt: '楽マッチ AI｜不動産仲介営業専門の顧客・物件管理AI（月3,000円・税込）' }],
  },
  twitter: {
    ...
    <html lang="ja" className={`${notoSansJP.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-surface-50 text-ink-900">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "楽マッチ AI",
          "description": "不動産仲介営業専門の顧客・物件管理AI。顧客と物件の双方向マッチング、コピペ・PDFでの物件登録、通話録音の文字起こし・要約、お客様連動アプリ、契約・精算まで一元化。",
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "お客様連動アプリは、お客様にアプリのインストールが必要ですか？", "acceptedAnswer": { "@type": "Answer", "text": "リンクから使えて、ログインは不要です。気になった物件を1か所に集約でき、その内容が担当者に届きます。" }},
            { "@type": "Question", "name": "通話録音は特別な機材がいりますか？", "acceptedAnswer": { "@type": "Answer", "text": "選んだマイクに入る音を録る方式なので、携帯でも固定電話でも対面でも使えます。高額な電話システムは不要です（録音はお相手の同意のうえで）。" }},
