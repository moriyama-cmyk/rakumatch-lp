...
export function FinalCta() {
  return (
    <Section id="cta" labelledBy="cta-heading" className="border-t-2 border-primary-600/20 bg-white" spacing="xl">
      <Container>
        <Reveal>
          <div className="relative overflow-hidden rounded-xl bg-surface-900 px-5 py-12 text-center ring-1 ring-white/5 sm:px-14 sm:py-20">
            ...
            <div className="relative mx-auto max-w-2xl">
              ...
              <h2 id="cta-heading" className="mt-4 text-display-xl text-white">{hl('まずは、', '画面で', '確かめて', 'ください。')}</h2>
              ...
              <div className="mx-auto mt-8 grid max-w-xl gap-3 text-left sm:grid-cols-2">
                <GlowButton
                  ...
                  onClick={() => trackCta('demo', 'final_demo', SITE.ctaTryUrl)}
                >
                ...
                <GlowButton
                  ...
                  size="lg"
                  className="!h-auto min-h-14 w-full flex-col !items-start px-5 py-3 text-left sm:px-6"
                  onClick={() => trackCta('trial', 'final_trial', SITE.ctaTrialUrl)}
                >
